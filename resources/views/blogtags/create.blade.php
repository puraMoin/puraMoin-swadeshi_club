...
<section class="section">
    ...
    <!-- For Start Here -->
   <form method="POST" action="{{ route('blogtags.store') }}" enctype="multipart/form-data">  
  <div class="card-style mt-20">
      <!-- Form Start Here -->
       ...
       <div class="row mt-15">        
         ...
         <div class="col-sm-4">
            ...
            <input type="text"  name="name" placeholder="Enter Name"  id="BlogTagName" required="true" />
            </div>   
         </div>
    ...
    <!-- Page Slug -->
     <div class="col-sm-4">
            ...
            <input type="text"  name="page_slug" placeholder="Enter Page Slug" id="BlogTagSlug" required="true" />
            </div>   
     </div>
    ...
    <!-- Page Url -->
     <div class="col-sm-8">
            ...
            <input type="text"  name="page_url" placeholder="Page Url" id="BlogTagUrl" required="true" />
            </div>   
     </div>  
