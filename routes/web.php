...
use App\Http\Controllers\AvailableColorsController;
use App\Http\Controllers\AvailableSizesController;
...
Route::prefix('countries')->group(function () {
 ...
 /*Route::post('/store-password', [UsersController::class, 'changePassword'])->name('store-password');*/
  ...
  Route::resource('availablecolors', AvailableColorsController::class);
  Route::resource('availablesizes', AvailableSizesController::class);
  Route::resource('brands', BrandsController::class);
  Route::resource('categories', CategoriesController::class);
  Route::resource('subcategories', SubCategoriesController::class);
  Route::resource('producttypes', ProductTypesController::class);  
